...
module ActiveRecordCustomPreloader
  class AssociationsPreloader < ::ActiveRecord::Associations::Preloader
    ...
    def preloaders_on(association, records, scope, polymorphic_parent = false)
      ...
      if assoc
        preloaders_for_custom(assoc, records, nested_assocs, scope, polymorphic_parent)
        return
      end
    ...
    # @param records [Array]
    def preloaders_for_custom(association, records, nested_assocs, scope, polymorphic_parent)
